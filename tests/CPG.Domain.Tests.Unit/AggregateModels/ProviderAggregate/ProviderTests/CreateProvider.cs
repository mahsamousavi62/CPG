...
{
    private static Provider Act(PersianName persianName, EnglishName englishName, ProviderType providerType, Logo logo, string providerData)
           => Provider.Create(persianName, englishName, providerType, logo, providerData);
