...
public class CreateUserCommandHandler(IMediator mediator, IAggregateRepository<User> repository, IHttpClientFactoryService httpClientFactoryService) : IRequestHandler<CreateUserCommnad>
{
