...
public class IPGTransactionConfiguration : IEntityTypeConfiguration<IPGTransaction>
{
    public void Configure(EntityTypeBuilder<IPGTransaction> entity)
    {
        ...
        entity.Property(x => x.ProviderTrackerId).HasColumnName("ProviderTrackerId").HasColumnType("nvarchar(255)");
        entity.Property(x => x.ReferenceNumber).HasColumnName("ReferenceNumber").HasColumnType("varchar(255)");
        entity.Property(x => x.EncryptCardNumber).HasColumnName("EncryptCardNumber").HasColumnType("varchar(255)");
        entity.Property(x => x.VerificationTimeLimit).HasColumnName("VerificationTimeLimit").HasColumnType("int");
        entity.Property(x => x.PredicateExpirationDateTime).HasColumnName("PredicateExpirationDateTime").HasColumnType("datetime2");
        entity.Property(x => x.VerificationDateTime).HasColumnName("VerificationDateTime").HasColumnType("datetime2");
