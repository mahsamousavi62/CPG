...
namespace CPG.Infrastructure.Persistence.DbContexts.EntityConfigurations
{
    public class BankConfiguration : IEntityTypeConfiguration<Bank>
    {
        public void Configure(EntityTypeBuilder<Bank> entity)
        {
            ...
            entity.Property(x => x.Name).HasMaxLength(256).HasColumnType("nvarchar").IsUnicode(true).UseCollation("Persian_100_CI_AI").IsRequired();

            entity.Property(x => x.Logo).HasMaxLength(256).HasColumnType("varchar").IsRequired();

            entity.Property(x => x.HasDirectDebitFeature).HasColumnType("bit");
