...
public class TransactionReadModelConfiguration : IEntityTypeConfiguration<TransactionReadModel>
{
    public void Configure(EntityTypeBuilder<TransactionReadModel> entity)
    {
        ...
        entity.Property(x => x.ReferenceTransactionId).HasColumnName("ReferenceTransactionId");
        ...
        entity.HasOne(t => t.IPGTransaction).WithOne(t => t.Transaction).HasForeignKey<TransactionReadModel>(t => t.ReferenceTransactionId);
    }
}
