...
{
    public class PaymentReceiptTransactionSortType : SortInputType<PaymentReceiptTransactionReportViewModel>
    {
        protected override void Configure(ISortInputTypeDescriptor<PaymentReceiptTransactionReportViewModel> descriptor)
        {
