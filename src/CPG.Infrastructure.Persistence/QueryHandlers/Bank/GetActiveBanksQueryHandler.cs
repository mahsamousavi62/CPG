...
public class GetActiveBanksQueryHandler(ReadDbContext context, IMinioProvider minioProvider) : IRequestHandler<GetActiveBanksQuery, IReadOnlyCollection<BankViewModel>>
{
