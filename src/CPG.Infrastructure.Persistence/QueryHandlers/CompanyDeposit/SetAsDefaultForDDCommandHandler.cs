...
public class SetAsDefaultForDDCommandHandler(IAggregateRepository<CompanyDeposit> companyDepositRepository,
    IAggregateRepository<Company> companyRepository,
    WriteDbContext context) : IRequestHandler<SetAsDefaultForDDCommand, Result<bool>>
{
