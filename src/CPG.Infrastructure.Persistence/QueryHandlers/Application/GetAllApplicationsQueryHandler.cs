...
public class GetAllApplicationsQueryHandler(ReadDbContext context, IMinioProvider minioProvider) : IRequestHandler<GetAllApplicationsQuery, Result<IReadOnlyCollection<ApplicationViewModel>>>
{
