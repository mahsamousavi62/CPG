...
public class GetAllApplicationsQueryHandler(ReadDbContext context, IMinioProvider minioProvider) : IRequestHandler<GetAllApplicationsQuery, IReadOnlyCollection<ApplicationViewModel>>
{
