        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IDPId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    LastUpdateFromIDP = table.Column<DateTime>(type: "datetime2", nullable: false),
                    KYCStatus = table.Column<short>(type: "smallint", nullable: false),
                    IsLegal = table.Column<bool>(type: "bit", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatationDateTime = table.Column<DateTime>(type: "datetime2", nullable: false),
