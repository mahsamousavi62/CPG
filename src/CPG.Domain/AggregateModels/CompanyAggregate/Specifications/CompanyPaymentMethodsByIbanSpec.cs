...
public class CompanyPaymentMethodsByIbanSpec : Specification<Company>, ISingleResultSpecification<Company>
{
    public CompanyPaymentMethodsByIbanSpec(long companyId, string destinationIban)
    {
